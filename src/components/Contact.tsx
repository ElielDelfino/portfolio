        ...
        <div className="contact-content">
          <div className="contact-description-wrapper">
            <p className="contact-description">
              Aberto a novas oportunidades e colaborações. Entre em
          ...
          <div className="contact-links">
            ...
            >
              ...
              <span>eliel.delfino@fanut.ufal.br</span>
            </a>
            <a
              href="https://wa.me/5582981068282"
              className="contact-item"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <a
              href="https://github.com/ElielDelfino"
              className="contact-item"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <a
              href="https://www.linkedin.com/in/eliel-delfino-45300b2a1/"
              className="contact-item"
              target="_blank"
              rel="noopener noreferrer"
            >
